    ...
    <Section>
      <Container>
        ...
        <BlurFade delay={0.1} inView>
          <div className="mx-auto max-w-3xl overflow-hidden rounded-2xl border border-border/50 bg-card/30">
            {/* Table Header */}
            <div className="grid grid-cols-4 gap-px border-b border-border/50 bg-card/60 px-6 py-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
            ...
            {benchmarkRows.map(({ key }, idx) => (
              <BlurFade key={key} delay={0.15 + idx * 0.05} inView>
                <div
                  ...
                  className="grid grid-cols-4 gap-px border-b border-border/30 px-6 py-4 last:border-b-0"
                >
                  ...
                  <span className="text-center text-sm font-medium tabular-nums text-primary">
                    {t(`${key}Sqlite`)}
                  </span>
        ...
        <BlurFade delay={0.4} inView>
          <div className="mx-auto mt-8 flex max-w-3xl flex-col items-center gap-3">
            <Badge className="gap-2 bg-primary/10 px-5 py-2 text-base font-bold text-primary">
