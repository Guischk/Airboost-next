    ...
    <Section>
      <Container>
        ...
        <div className="relative mx-auto max-w-2xl">
          {/* Connecting line */}
          <div className="absolute top-0 bottom-0 left-6 z-0 w-px bg-gradient-to-b from-primary/40 via-primary/20 to-transparent md:left-8" />
            ...
            {steps.map(({ key, icon: Icon }, idx) => (
              <BlurFade key={key} delay={0.1 + idx * 0.1} inView>
                <div className="flex gap-5 md:gap-6">
                  {/* Step Number */}
                  <div className="flex size-12 shrink-0 items-center justify-center rounded-xl border border-primary/30 bg-primary/10 md:size-16">
